    ...
    <section class="members">
        <div class="container">
            ...
            <div class="members__list">
                <!-- Members List Item -->
                <div class="members__list__item add-member text-center">
                ...
                <div class="members__list__item text-center">
                    <div class="members__list__item__top">
                        <div class="members__avatar">
                            <img src="img/img2.png" alt="" class="img-circle" height="72" width="72">
                        </div>
                        <div class="members__name">Edgar Wilkins</div>
                        <div class="members__location">East Mauriceburgh</div>
                        <div class="members__social">
                ...
                <div class="members__list__item text-center">
                    <div class="members__list__item__top">
                        <div class="members__avatar">
                            <img src="img/img3.png" alt="" class="img-circle" height="72" width="72">
                        </div>
                        <div class="members__name">Edgar Wilkins</div>
                        <div class="members__location">East Mauriceburgh</div>
                        <div class="members__social">
                ...
                <div class="members__list__item text-center">
                    <div class="members__list__item__top">
                        <div class="members__avatar">
                            <img src="img/img4.png" alt="" class="img-circle" height="72" width="72">
                        </div>
                        <div class="members__name">Edgar Wilkins</div>
                        <div class="members__location">East Mauriceburgh</div>
                        <div class="members__social">
                ...
                <div class="members__list__item text-center">
                    <div class="members__list__item__top">
                        <div class="members__avatar">
                            <img src="img/img5.png" alt="" class="img-circle" height="72" width="72">
                        </div>
                        <div class="members__name">Edgar Wilkins</div>
                        <div class="members__location">East Mauriceburgh</div>
                        <div class="members__social">
